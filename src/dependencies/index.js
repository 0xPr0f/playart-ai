...
export default class CanvasDraw extends PureComponent {
  static propTypes = {
    ...
    DrawingTime: PropTypes.func,
    liveDrawTimeEject: PropTypes.func,
  ...
  constructor(props) {
    ...
    this.ctx = {}
    this.liveDrawTime = 0
    this.catenary = new getCatenaryCurve()
    ...
    lines.forEach((line) => {
      ...
      for (let i = 1; i < points.length; i++) {
        ...
        window.setTimeout(() => {
          ...
          this.triggerOnLiveDrawTimeEject()
        }, curTime)
      }
      ...
      window.setTimeout(() => {
        ...
        this.points = points
        this.saveLine({ brushColor, brushRadius })
        this.triggerOnLoadEnd()
      }, curTime)
    })
    this.triggerDrawingTime(curTime)
  }
  ...
  triggerOnLoadEnd = () => {
    this.props.onLoadEnd && this.props.onLoadEnd(this)
  }
  triggerOnLiveDrawTimeEject = () => {
    this.liveDrawTime += 1
    this.props.liveDrawTimeEject &&
      this.props.liveDrawTimeEject(this.liveDrawTime)
  }

  triggerDrawingTime = (time) => {
    this.props.DrawingTime && this.props.DrawingTime(time)
  }

  triggerOnLoadStart = () => {
    this.props.onLoadStart && this.props.onLoadStart(this)
  }
